...
export function FornecedorModal({ open, onOpenChange, onSuccess }: FornecedorModalProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha os dados do fornecedor. Apos criar, ele sera selecionado automaticamente.
          </DialogDescription>
        </DialogHeader>
