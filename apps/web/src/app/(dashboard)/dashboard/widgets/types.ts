...
export const DEFAULT_GRID_LAYOUT: GridItem[] = [
  ...
  { i: "kpiLucroLiquido",     x: 2, y: 2,  w: 2, h: 1 },
  { i: "kpiReceber",          x: 4, y: 2,  w: 2, h: 1 },
  { i: "kpiPagar",            x: 6, y: 2,  w: 2, h: 1 },
  { i: "kpiEstoqueCusto",     x: 0, y: 3,  w: 2, h: 1 },
  { i: "kpiEstoqueFaturamento", x: 2, y: 3, w: 2, h: 1 },
  { i: "kpiClientes",         x: 4, y: 3,  w: 2, h: 1 },
  { i: "kpiEmRevisao",        x: 6, y: 3,  w: 2, h: 1 },
  ...
  { i: "diasEstoque",         x: 0, y: 16, w: 4, h: 5 },
  { i: "lucroMarca",          x: 4, y: 16, w: 4, h: 5 },
  { i: "faixasLucroBruto",    x: 0, y: 21, w: 4, h: 3 },
];
...
export const SECTION_LABELS: Record<SectionId, string> = {
  ...
  kpiLucroLiquido: "Lucro Liquido por Peca",
  ...
  lucroMarca: "Lucro Bruto por Peca (por marca)",
  diasEstoque: "Dias de Estoque",
  graficos: "Graficos",
